...
declare var google;
@Component({
  selector: 'app-addback',
  templateUrl: './addback.page.html',
  styleUrls: ['./addback.page.scss'],
})
export class AddbackPage implements OnInit {
  public route_id;
  public loading: any;
  ...
  async loadmap() {
    ...
    this.map = new google.maps.Map(document.getElementById('backmap'), {
      zoom: 16,
